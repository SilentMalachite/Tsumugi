...
- 2026-06-29付のPhase 3旧計画は実行対象外。後続の現行計画は [`docs/superpowers/plans/2026-07-11-phase3-1-claim-calculation-and-input-foundation.md`](superpowers/plans/2026-07-11-phase3-1-claim-calculation-and-input-foundation.md) として作成済み。
