...
| `r8-grant-decision-administration-202606` | https://www.mhlw.go.jp/content/12200000/001470632.pdf | `d6e1672245370d2d7bb9a4258622ae3e631d0a6144c8e0c9ea51e2018a146f1e` / 1,998,305 bytes。ADR 0020登録値と一致（正本＝厚労省版。live URLは404のためバイト列をhistorical保持。page番号は北九州市の再配布PDF `c5070de8…` で読み取り、physical pages 233〜235のテキストSHA-256一致とpage数262一致でpage付け同一を確認） | p182〜186、p197〜199。上限額管理、月次給付単位数、総費用額、1割相当額、決定負担額、給付費 |
