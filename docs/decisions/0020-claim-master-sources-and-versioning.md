...
| burden-caps / upper-limit-management | r6-disability-support-guide-202404。2024-05サービス月はr6-claim-handbook-202405も使用 | r6-disability-support-guide-202404、r6-claim-handbook-202405 | r6-disability-support-guide-202404、r8-grant-decision-administration-202606 |
...
r6-claim-handbook-202405は、受給者証の負担上限月額、上限額管理の一般フロー、管理結果1〜3、および上限情報・管理結果の不整合がエラーとなることの根拠に限定する。physical page 18の徴収順は「障害児通所の場合」であり、成人の就労継続支援B型へ適用しない。令和6版の成人B型の徴収優先順は本資料から推測せず、一次資料で確定するまで未確定とする。
