...
| burden-caps / upper-limit-management | r6-disability-support-guide-202404。r6-claim-handbook-202405は2024-05の境界・一般フロー確認だけに使用し、2024-04へ遡及しない | r6-disability-support-guide-202404のみ。成人B型の上限額管理対象は成人用一次資料を追加するまで算定不能 | r6-disability-support-guide-202404、r8-grant-decision-administration-202606 |
...
r6-claim-handbook-202405は2024-05サービス月だけを対象とし、成人B型にはphysical pages 16〜17の一般的な上限額管理フローと、pages 19〜20の入力不整合・適用境界の存在確認だけに使用する。physical page 18全体は「障害児通所の場合」であり、徴収順だけでなく管理結果区分1〜3と金額関係も成人B型の検証へ使用しない。2024-04へ遡及せず、2024-04〜2026-05の成人B型で上限額管理対象となる請求は、成人用一次資料を不変バイトで追加するまで算定不能とする。上限額管理対象外の通常上限制御はADR 0022に従い継続する。
