...
就労継続支援B型の請求マスタは、サービス提供年月で次の5版を選択する。

| masterVersion | effectiveFrom | effectiveTo | 用途 |
| --- | --- | --- | --- |
| claim-master-r6-04 | 2024-04 | 2024-05 | 令和6年4月施行の基本報酬、加算・減算、体制、サービスコード |
| claim-master-r6-06 | 2024-06 | 2024-12 | 令和6年6月施行分を反映した令和6版。上限額管理はR6年4月資料を使用 |
| claim-master-r7-01 | 2025-01 | 2025-08 | 令和6年6月施行の報酬・コード束を継続し、上限額管理だけR7年1月資料へ置換 |
| claim-master-r7-09 | 2025-09 | 2026-05 | 令和6年6月施行の報酬・コード束を継続し、上限額管理だけR7年9月資料へ置換 |
...
| region-unit-prices | mhlw-unit-price-notice-observed-946c3d96 と r6-revision-overview | 同左 | 同左。令和8改定で単価表の置換なし |
...
| burden-caps / upper-limit-management | 制度額はr6-disability-support-guide-202404。成人上限額管理は2024-04〜2024-12にr6-grant-decision-administration-202404を選択。r6-claim-handbook-202405は境界確認だけに使用 | 制度額はr6-disability-support-guide-202404。成人上限額管理は2025-01〜2025-08にr7-grant-decision-administration-202501、2025-09〜2026-05にr7-grant-decision-administration-202509を選択 | 制度額はr6-disability-support-guide-202404、成人上限額管理はr8-grant-decision-administration-202606 |

各版のSourceDocumentIdsは次の閉じたリストとし、再取得時に同一バイトを特定できる公式PDF、XLS、XLSX、および直接制度値を含み反復取得でバイト安定性を確認した公式法令HTMLだけを含める。ここにない資料を暗黙に参照せず、全IDが後述の公式資料カタログに解決できることを登録時に検証する。

| masterVersion | SourceDocumentIds |
| --- | --- |
| claim-master-r6-04 | [mhlw-unit-price-notice-observed-946c3d96,r6-revision-overview,r6-fee-notice,r6-calculation-note,r6-employment-guidance-r6,r6-employment-guidance,r6-employment-guidance-corr-4,r6-qa-v1,r6-qa-v2,r6-qa-v3,r6-qa-v5,r6-qa-v6,r6-qa-v7,r6-qa-v8,r6-calculation-corr-1,r6-calculation-corr-3,r6-calculation-corr-5,r6-calculation-corr-6,r6-calculation-corr-7,r6-calculation-corr-8,r6-qa-corr-1,r6-qa-corr-2,r6-qa-corr-3,r6-capability-202404,r6-reward-structure,r6-service-codes-2-pdf,r6-service-codes-2-xlsx,r6-claim-decision-202404-pdf,r6-claim-decision-202404-xls,r6-disability-support-guide-202404,r6-claim-handbook-202405,r6-grant-decision-administration-202404,current-fee-notice-html,protected-facility-administrative-expense-standard-html,h31-fee-notice-consolidated] |
| claim-master-r6-06 | [mhlw-unit-price-notice-observed-946c3d96,r6-revision-overview,r6-fee-notice,r6-calculation-note,r6-employment-guidance-r6,r6-employment-guidance,r6-employment-guidance-corr-4,r6-qa-v1,r6-qa-v2,r6-qa-v3,r6-qa-v5,r6-qa-v6,r6-qa-v7,r6-qa-v8,r6-calculation-corr-1,r6-calculation-corr-3,r6-calculation-corr-5,r6-calculation-corr-6,r6-calculation-corr-7,r6-calculation-corr-8,r6-qa-corr-1,r6-qa-corr-2,r6-qa-corr-3,r6-capability-202406,r6-reward-structure,r6-service-codes-2-pdf,r6-service-codes-2-xlsx,r6-claim-decision-202406-pdf,r6-claim-decision-202406-xls,r6-disability-support-guide-202404,r6-grant-decision-administration-202404,current-fee-notice-html,protected-facility-administrative-expense-standard-html,h31-fee-notice-consolidated] |
| claim-master-r7-01 | [mhlw-unit-price-notice-observed-946c3d96,r6-revision-overview,r6-fee-notice,r6-calculation-note,r6-employment-guidance-r6,r6-employment-guidance,r6-employment-guidance-corr-4,r6-qa-v1,r6-qa-v2,r6-qa-v3,r6-qa-v5,r6-qa-v6,r6-qa-v7,r6-qa-v8,r6-calculation-corr-1,r6-calculation-corr-3,r6-calculation-corr-5,r6-calculation-corr-6,r6-calculation-corr-7,r6-calculation-corr-8,r6-qa-corr-1,r6-qa-corr-2,r6-qa-corr-3,r6-capability-202406,r6-reward-structure,r6-service-codes-2-pdf,r6-service-codes-2-xlsx,r6-claim-decision-202406-pdf,r6-claim-decision-202406-xls,r6-disability-support-guide-202404,r7-grant-decision-administration-202501,current-fee-notice-html,protected-facility-administrative-expense-standard-html,h31-fee-notice-consolidated] |
| claim-master-r7-09 | [mhlw-unit-price-notice-observed-946c3d96,r6-revision-overview,r6-fee-notice,r6-calculation-note,r6-employment-guidance-r6,r6-employment-guidance,r6-employment-guidance-corr-4,r6-qa-v1,r6-qa-v2,r6-qa-v3,r6-qa-v5,r6-qa-v6,r6-qa-v7,r6-qa-v8,r6-calculation-corr-1,r6-calculation-corr-3,r6-calculation-corr-5,r6-calculation-corr-6,r6-calculation-corr-7,r6-calculation-corr-8,r6-qa-corr-1,r6-qa-corr-2,r6-qa-corr-3,r6-capability-202406,r6-reward-structure,r6-service-codes-2-pdf,r6-service-codes-2-xlsx,r6-claim-decision-202406-pdf,r6-claim-decision-202406-xls,r6-disability-support-guide-202404,r7-grant-decision-administration-202509,current-fee-notice-html,protected-facility-administrative-expense-standard-html,h31-fee-notice-consolidated] |
| claim-master-r8-06 | [mhlw-unit-price-notice-observed-946c3d96,r6-revision-overview,r8-revision-overview,r8-fee-notice,r8-calculation-note,r8-b-reward-band-guide,r8-employment-transition-guide,r8-qa-v1,r8-amendment-qa,r8-capability-202606,r8-capability-correction,r8-reward-structure,r8-service-codes-2-pdf,r8-service-codes-2-xlsx,r8-claim-decision-pdf,r8-claim-decision-xls,r6-disability-support-guide-202404,r8-grant-decision-administration-202606,current-fee-notice-html,protected-facility-administrative-expense-standard-html] |

基準該当B型の公式式・provenance資料は、実装済み`src/Tsumugi.Infrastructure/ClaimMasters/Seed/sources.json`と同じく、`claim-master-r6-04`、`claim-master-r6-06`、`claim-master-r7-01`及び`claim-master-r7-09`の末尾に`current-fee-notice-html`、`protected-facility-administrative-expense-standard-html`、`h31-fee-notice-consolidated`の3 IDsを、`claim-master-r8-06`の末尾に前2 IDsだけを含める。

- `current-fee-notice-html`は2026-06-01施行の現行統合本文として式、比較、地方公共団体補正及び4月1日入力要件の`authoritative` sourceである。R6への使用はcontinuity inferenceであり、R6期間の直接根拠又はeffective-period根拠として扱わない。
- `protected-facility-administrative-expense-standard-html`は実値の由来要件を示す`authoritative` sourceであるが、保護施設事務費の実値seed、resolver又はruntime算定の実装を意味しない。
- `h31-fee-notice-consolidated`はR6の式継続性だけを確認する`cross-check`であり、有効正本candidate又はR8 releaseへ含めない。
- `r8-fee-notice`は基準該当B型のR8改正関係を確認する`cross-check`として扱い、この用途で`corrects`へ追加しない。既存の`supersedes = [r6-fee-notice]`は一般的な版関係として維持する。

動的な索引・入口HTMLはマスタ値入力ではなく、公式ファイルの所在とページ上の判断根拠を示すロケータ証拠として次の別表で管理する。同一URLが複数バイトを返すため、単一の「現行SHA」は定義せず、観測できたバリアントだけを列挙する。このリストは全バリアントの網羅を保証しない。直接制度値を含み、反復取得で同一バイトを確認した公式法令HTMLはこのロケータ表へ含めず、SourceDocumentIdsで管理する。

| masterVersion | LocatorEvidenceDocumentIds | evidenceScope |
| --- | --- | --- |
| claim-master-r6-04 | [mhlw-r6-revision-page-observed-c7b78655,mhlw-r6-revision-page-observed-fefe2d88,mhlw-r6-structure-page-observed-8a9858bf] | 令和6改定資料・構造表等の所在を確認するロケータ証拠。マスタ値入力には使用しない |
| claim-master-r6-06 | [mhlw-r6-revision-page-observed-c7b78655,mhlw-r6-revision-page-observed-fefe2d88,mhlw-r6-structure-page-observed-8a9858bf] | 令和6年6月施行資料・確定サービスコードの所在を確認するロケータ証拠。マスタ値入力には使用しない |
| claim-master-r7-01 | [mhlw-r6-revision-page-observed-c7b78655,mhlw-r6-revision-page-observed-fefe2d88,mhlw-r6-structure-page-observed-8a9858bf] | 継続使用する令和6年6月施行資料・確定サービスコードの所在を確認するロケータ証拠。マスタ値入力には使用しない |
| claim-master-r7-09 | [mhlw-r6-revision-page-observed-c7b78655,mhlw-r6-revision-page-observed-fefe2d88,mhlw-r6-structure-page-observed-8a9858bf] | 継続使用する令和6年6月施行資料・確定サービスコードの所在を確認するロケータ証拠。マスタ値入力には使用しない |
| claim-master-r8-06 | [mhlw-r8-revision-page-observed-2e8f1425,mhlw-r8-revision-page-observed-7c937a6a,mhlw-r8-structure-page-observed-9bc71ce6,mhlw-r8-structure-page-observed-13da3c44] | 令和8改定資料・構造表等の所在、5項目の「変更なし」、対応表の新規掲載を確認するロケータ証拠。マスタ値入力には使用しない |
...
r6-claim-handbook-202405は2024-05サービス月だけを対象とし、成人B型にはphysical pages 16〜17の一般的な上限額管理フローと、pages 19〜20の入力不整合・適用境界の存在確認だけに使用する。physical page 18全体は「障害児通所の場合」であり、徴収順、管理結果区分1〜3、金額関係のいずれも成人B型の検証へ使用しない。成人B型の上限額管理は、サービス月ごとにr6-grant-decision-administration-202404、r7-grant-decision-administration-202501、r7-grant-decision-administration-202509、r8-grant-decision-administration-202606の順で版を解決し、後版を過去月へ遡及しない。各releaseは当月のgrant-decision-administration資料をちょうど1件だけ含み、将来版を先取りしない。R6とR7年1月版のphysical pages 170〜183は抽出本文が一致するが、supersedesの適用境界は維持する。

サービスコード分割1は就労継続支援B型のシートを含まないため、5版のSourceDocumentIdsには含めない。分割1の資料は非入力コンテキストとしてカタログにのみ残す。

令和6版は2025年1月31日確定のサービスコード表を正本とし、2024年11月29日以前の掲載ファイルへ戻さない。令和8版は2026年4月28日更新のサービスコード表と、修正箇所を反映した体制状況一覧表を正本とする。

地域区分単価は、就労継続支援について厚生労働省告示第539号の現行条文に記載された次の値を採用する。金額は基準額10円に告示の割合を乗じた結果であり、令和6年度改定概要が地域区分を「令和6〜8年度」の適用地域としているため、claim-master-r6-04、claim-master-r6-06、claim-master-r7-01、claim-master-r7-09、claim-master-r8-06で共通に使用する。
...
各外部マスタは documentId、title、publisher、effectiveAt、publishedAt、retrievedAt、url、sha256、supersedes、corrects、supplements、applicabilityNote、correctionNote を保持する。安定したPDF、XLS、XLSXまたは公式法令HTMLが同じURLで公式に差し替えられた場合は、既存documentIdを上書きせず、新しいdocumentIdと取得日で登録する。動的な索引・入口HTMLは差替え時系列を推測せず、取得バイトのSHA-256接頭辞を含む観測バリアントIDで登録し、バリアント間にsupersedesまたはcorrectsを設定しない。直接制度値を含む公式法令HTMLは反復取得で同一SHA-256・サイズ・値条文を確認できた場合に限りSourceDocumentIdsへ含める。必要資料、適用版、訂正関係のいずれかが欠ける場合は算定を停止し、近い値や前版を推測適用しない。
...
- claim-master-r6-06は2024年6月施行資料を2024-12まで使用し、サービスコードは公式ページの「11月29日修正、1月31日確定分」を使用する。B型に関係する留意事項、Q&A VOL.5〜8、正誤その4／6を含む正誤資料も適用する。
- claim-master-r7-01とclaim-master-r7-09は令和6年6月施行の報酬・コード束を継続し、上限額管理資料だけを各effectiveFromで置換する。後続のgrant資料を同じreleaseへ混在させない。
...
retrievedAtは別記がない限り2026-07-10であり、成人上限額管理の新規3資料は2026-07-11である。publisherは、別記がない限り厚生労働省である。effectiveAtは必ず単一のISO 8601日付（YYYY-MM-DD）とし、次の順で決定する。
...
| mhlw-unit-price-notice-observed-946c3d96 | こども家庭庁長官及び厚生労働大臣が定める一単位の単価並びに厚生労働大臣が定める一単位の単価（厚生労働省告示第539号・観測バイト946c3d96・52,785 bytes） | こども家庭庁・厚生労働省 | 2006-10-01 | 2006-09-29 | 2026-07-10 | https://www.mhlw.go.jp/web/t_doc?dataId=83aa8493&dataType=0&pageNo=1 | 946c3d969ffd4128db15106d25ce6d26ff108f5460a7618e3df96352e42c0c1b | null | null | null | 2026-07-10の独立12回取得でSHA-256と52,785 bytesが一致。B型を含む基準額10円と1〜7級地・その他の割合を直接収載するため、5版共通のマスタ値ソースとする | null |

#### 令和6資料

| documentId | title | publisher | effectiveAt | publishedAt | retrievedAt | url | sha256 | supersedes | corrects | supplements | applicabilityNote | correctionNote |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| r6-disability-support-guide-202404 | 障害者総合支援法 地域社会における共生の実現に向けて（2024年4月版） | 厚生労働省 | 2024-04-01 | null | 2026-07-10 | https://www.mhlw.go.jp/content/12200000/001327493.pdf | 3ead1b2d235ff15e6d0c71a129e7ef880e119272a00acd043e635aee8c637469 | null | null | null | effectiveAtは資料の「2024年4月版」を月初に正規化。physical page 9（printed page 17）に生活保護0円、低所得0円、一般1 9,300円、一般2 37,200円と、一般1の所得割16万円未満・20歳以上入所施設利用者とグループホーム利用者を除く条件を収載。制度区分値の根拠として5版に含めるが、受給者証の実値を上書きしない | null |
| r6-claim-handbook-202405 | 障害福祉サービス・障害児支援 請求事務ハンドブック（令和6年5月版） | 国民健康保険中央会 | 2024-05-01 | 2024-05-31 | 2026-07-10 | https://cdn.jshien.e-seikyuu.jp/jiritsu/202606001/faq/%E8%AB%8B%E6%B1%82%E4%BA%8B%E5%8B%99%E3%83%8F%E3%83%B3%E3%83%89%E3%83%96%E3%83%83%E3%82%AF_2024%E5%B9%B45%E6%9C%88%E7%89%88.pdf | 700e124690489c747655e9ca5227f370a51e8f93ae5141962f2c29f6f69f8c1d | null | null | null | effectiveAtは資料の「令和6年5月版」を月初に正規化し、publishedAtは公式お知らせの提示開始日に基づく。成人B型にはphysical pages 16〜17の一般上限額管理フローとpages 19〜20の入力不整合・適用境界の存在確認だけに使用する。physical page 18全体は障害児通所用であり、徴収順、管理結果区分1〜3、金額関係のいずれも成人B型の検証へ使用しない。2024-04へ遡及せず、R6-06版にも含めない | null |
| r6-grant-decision-administration-202404 | 介護給付費等に係る支給決定事務等について（事務処理要領・最終改正令和6年4月） | 厚生労働省（福島県公式ページ再配布） | 2024-04-01 | 2024-03-29 | 2026-07-11 | https://www.pref.fukushima.lg.jp/uploaded/attachment/624888.pdf | ddbcaf0421f9fad4fcb925515247363ea19eb5880dbb0f4d8b54922dada303c8 | null | null | null | 福島県公式配布ページの項目（16）が2024-03-29付の厚生労働省・こども家庭庁通知の【溶け込み】事務処理要領として再配布。4,587,513 bytes・256 pages。physical pages 170〜183の成人B型上限額管理規則を2024-04〜2024-12に適用 | null |
| r7-grant-decision-administration-202501 | 介護給付費等に係る支給決定事務等について（事務処理要領・最終改正令和7年1月） | 厚生労働省 | 2025-01-01 | null | 2026-07-11 | https://web.archive.org/web/20250317120118id_/https://www.mhlw.go.jp/content/12200000/001242850.pdf | f3667ee8504dd86c39ae9bd35996f67ba03b89115878fa76a05eaa6d181f9f8e | [r6-grant-decision-administration-202404] | null | null | 厚生労働省の旧原URL https://www.mhlw.go.jp/content/12200000/001242850.pdf は現在HTTP 404。Internet Archiveの公式origin capture 20250317120118からraw locatorで1,881,376 bytes・256 pagesを取得。physical pages 170〜183の抽出本文はR6版と一致し、2025-01〜2025-08に適用 | 2025-01からr6-grant-decision-administration-202404を置換し、過去月へ遡及しない |
| r7-grant-decision-administration-202509 | 介護給付費等に係る支給決定事務等について（事務処理要領・最終改正令和7年9月） | 厚生労働省 | 2025-09-01 | null | 2026-07-11 | https://web.archive.org/web/20251001223141id_/https://www.mhlw.go.jp/content/12200000/001571725.pdf | 243686e446eb695468ebe370ddabaed4b7743f5afd9ef60e29afc0019ead97cc | [r7-grant-decision-administration-202501] | null | null | 厚生労働省の旧原URL https://www.mhlw.go.jp/content/12200000/001571725.pdf は現在HTTP 404。Internet Archiveの公式origin capture 20251001223141からraw locatorで1,944,918 bytes・261 pagesを取得。physical page 172、174、181〜185の成人B型上限額管理規則を2025-09〜2026-05に適用 | 2025-09からr7-grant-decision-administration-202501を置換し、過去月へ遡及しない |
...
#### 基準該当B型公式式・provenance資料

| documentId | title | publisher | effectiveAt | publishedAt | retrievedAt | url | sha256 | supersedes | corrects | supplements | applicabilityNote | correctionNote |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| current-fee-notice-html | 障害者の日常生活及び社会生活を総合的に支援するための法律に基づく指定障害福祉サービス等及び基準該当障害福祉サービスに要する費用の額の算定に関する基準 | 厚生労働省 | 2026-06-01 | null | 2026-07-14 | https://www.mhlw.go.jp/web/t_doc?dataId=83aa8477&dataType=0&pageNo=6 | 0b5c75203f589701e8d0d3ba7cf192f4873b7aeae023da6e137882b225286768 | null | null | null | 現行統合本文を式・比較・地方公共団体補正・4月1日入力要件の正本とし、R6対応はcontinuity mappingReasonを必須とする | null |
| protected-facility-administrative-expense-standard-html | 生活保護法による保護施設事務費及び委託事務費の支弁基準について | 厚生労働省 | 2023-04-01 | 2023-03-28 | 2026-07-14 | https://www.mhlw.go.jp/web/t_doc?dataId=00tc7589&dataType=1 | e6d94b5279ca33d60daa83f29e6fdb1f5c3d1ba08f076812cf2c0f64a37ba8a5 | null | null | null | 保護施設事務費の施設別・地域別・定員別・通知provenanceに使用する | null |
| h31-fee-notice-consolidated | 障害者の日常生活及び社会生活を総合的に支援するための法律に基づく指定障害福祉サービス等及び基準該当障害福祉サービスに要する費用の額の算定に関する基準等の一部を改正する告示 | 厚生労働省 | 2019-10-01 | 2019-03-25 | 2026-07-14 | https://www.mhlw.go.jp/content/000520560.pdf | 79054870b88b1ca97b3b31a811857ed8a614e59da0b6d14435df30bcb5bf4bc9 | null | null | null | R6式継続性のcross-checkだけに使用し、有効正本candidateへ含めない | null |

### 採用理由

- URLだけでなく取得バイトのSHA-256を固定するため、公式サイトで同じURLの差替えがあっても過去請求の根拠を識別できる。
- 2024-04、2024-06、2025-01、2025-09、2026-06を別のマスタ版にし、成人上限額管理sourceのeffectiveAtとsupersedes chainを一致させるため、境界月でコード改修なしに正しい資料を選択できる。
...
- claim-master-r6-04、claim-master-r6-06、claim-master-r7-01、claim-master-r7-09、claim-master-r8-06の境界と、各releaseが当月のgrant資料を1件だけ含むことをテスト対象にする。
