...
- **年商閾値以外の除外条件（見落とし・v2 で追記）**: guide.html には年商閾値とは独立に、次の verbatim 記載がある。
  ...
  >
  > （出典: https://www.questpdf.com/license/guide.html。Codex レビューで年商閾値以外の除外条件が ADR 初版に未反映であることを指摘され、v2 で一次情報を再確認のうえ追記した。）

  すなわち年商が閾値未満であっても、**(a) 公的セクターの事業体・政府機関**、または **(b) 上場企業** に該当する場合は Community License の対象外となる（"regardless of revenue" と明記）。

### 発動条件（再判定トリガー）— 3 種の除外条件の確認

**これは付随的な注記ではなく、本 ADR の判断が有効であり続けるための第一級の条件である。**

QuestPDF Community License には独立した 3 つの除外条件があり、いずれか 1 つでも該当すれば Community License の継続適用を**再判定**しなければならない。

1. **Consolidated 年商閾値**: 運営法人が複数の施設・事業を運営しており、法人全体の合算年商（consolidated basis）が USD 1,000,000 に接近している、または既に超えている（超えることが見込まれる）場合。Tsumugi の実顧客には、単一の就労継続支援B型事業所ではなく、**B型＋A型＋生活介護＋グループホーム等の複数施設を運営する社会福祉法人**が多く含まれるため、法人単位の合算年商の確認が必須となる。
2. **公的セクターの事業体・政府機関（public-sector entities / government agencies）**: 導入先が地方自治体・独立行政法人等が運営する**公営の**就労継続支援B型事業所である場合、または既存の導入先の運営主体が民間法人から公的セクターに変わった場合。就労B型事業所の運営主体は社会福祉法人・NPO法人等の民間が大半だが、**公営（自治体直営等）で運営される事業所も存在しうる**ため、導入前に運営主体の性質を確認する。
3. **上場企業（publicly traded companies）**: 運営法人が株式公開している、または導入後に上場した場合。就労B型の運営法人が上場企業であるケースは稀だが、持株会社・グループ経営の一部として上場企業の子会社が運営する場合はこの条件に該当しうる。

再判定の結果 Community License の適用対象外と判明した場合は、下記フォールバック計画（Professional 移行 または Avalonia 印刷経路）のいずれかを選択し、別 ADR を起こす。単一事業所導入時点では安全マージンが大きいため、本 ADR は Community License 採用を確定するが、**法人単位の consolidated 収益確認・運営主体の属性確認なしに「今後も一切問題ない」と断定するものではない**。
