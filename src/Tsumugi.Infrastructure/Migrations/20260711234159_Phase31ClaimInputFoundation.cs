        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CertificateClaimEvidences_Article31AmountYen_EnteredYen", "((\"Article31AmountYen_IsEntered\" = 0 AND \"Article31AmountYen_ValueYen\" IS NULL) OR (\"Article31AmountYen_IsEntered\" = 1 AND \"Article31AmountYen_ValueYen\" >= 0))");
                    ...
                    table.CheckConstraint("CK_CertificateClaimEvidences_MonthlyCostCap_EnteredYen", "((\"MonthlyCostCap_IsEntered\" = 0 AND \"MonthlyCostCap_ValueYen\" IS NULL) OR (\"MonthlyCostCap_IsEntered\" = 1 AND \"MonthlyCostCap_ValueYen\" >= 0))");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OfficeClaimProfiles_AverageWageBandOption", "((\"AverageWageBandOption_Kind\" IS NULL AND \"AverageWageBandOption_OfficialOptionCode\" IS NULL) OR (\"AverageWageBandOption_Kind\" IN (1, 2, 3) AND \"AverageWageBandOption_OfficialOptionCode\" > 0))");
                    ...
                    table.CheckConstraint("CK_OfficeClaimProfiles_LaterRegisteredBandOption", "((\"LaterRegisteredBandOption_MasterVersion\" IS NULL AND \"LaterRegisteredBandOption_Option_Kind\" IS NULL AND \"LaterRegisteredBandOption_Option_OfficialOptionCode\" IS NULL) OR (length(trim(\"LaterRegisteredBandOption_MasterVersion\")) BETWEEN 1 AND 64 AND \"LaterRegisteredBandOption_Option_Kind\" IN (1, 2, 3) AND \"LaterRegisteredBandOption_Option_OfficialOptionCode\" > 0))");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UpperLimitManagementStatements_CertificateMonthlyCostCap_EnteredYen", "((\"CertificateMonthlyCostCap_IsEntered\" = 0 AND \"CertificateMonthlyCostCap_ValueYen\" IS NULL) OR (\"CertificateMonthlyCostCap_IsEntered\" = 1 AND \"CertificateMonthlyCostCap_ValueYen\" >= 0))");
                    ...
                    table.CheckConstraint("CK_UpperLimitManagementStatements_TotalCostYen_EnteredYen", "((\"TotalCostYen_IsEntered\" = 0 AND \"TotalCostYen_ValueYen\" IS NULL) OR (\"TotalCostYen_IsEntered\" = 1 AND \"TotalCostYen_ValueYen\" >= 0))");
                    table.CheckConstraint("CK_UpperLimitManagementStatements_TotalManagedBurdenYen_EnteredYen", "((\"TotalManagedBurdenYen_IsEntered\" = 0 AND \"TotalManagedBurdenYen_ValueYen\" IS NULL) OR (\"TotalManagedBurdenYen_IsEntered\" = 1 AND \"TotalManagedBurdenYen_ValueYen\" >= 0))");
                    table.CheckConstraint("CK_UpperLimitManagementStatements_TotalPreManagementBurdenYen_EnteredYen", "((\"TotalPreManagementBurdenYen_IsEntered\" = 0 AND \"TotalPreManagementBurdenYen_ValueYen\" IS NULL) OR (\"TotalPreManagementBurdenYen_IsEntered\" = 1 AND \"TotalPreManagementBurdenYen_ValueYen\" >= 0))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UpperLimitManagementStatementLines_ManagedBurdenYen_EnteredYen", "((\"ManagedBurdenYen_IsEntered\" = 0 AND \"ManagedBurdenYen_ValueYen\" IS NULL) OR (\"ManagedBurdenYen_IsEntered\" = 1 AND \"ManagedBurdenYen_ValueYen\" >= 0))");
                    table.CheckConstraint("CK_UpperLimitManagementStatementLines_PreManagementBurdenYen_EnteredYen", "((\"PreManagementBurdenYen_IsEntered\" = 0 AND \"PreManagementBurdenYen_ValueYen\" IS NULL) OR (\"PreManagementBurdenYen_IsEntered\" = 1 AND \"PreManagementBurdenYen_ValueYen\" >= 0))");
                    table.CheckConstraint("CK_UpperLimitManagementStatementLines_TotalCostYen_EnteredYen", "((\"TotalCostYen_IsEntered\" = 0 AND \"TotalCostYen_ValueYen\" IS NULL) OR (\"TotalCostYen_IsEntered\" = 1 AND \"TotalCostYen_ValueYen\" >= 0))");
                    table.ForeignKey(
